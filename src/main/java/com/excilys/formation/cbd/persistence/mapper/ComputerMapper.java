...
public class ComputerMapper implements RowMapper<Computer>{
	...
	public Computer mapRow(ResultSet rs, int rowNum) throws SQLException {
	    ...
	    try {	        
	    	newComputer = new ComputerBuilder(rs.getString(NAME_COMPUTER))
					.initializeWithId(rs.getLong(ID_COMPUTER))
					.build(); 
	        ...
	        newComputer.setCompany(
	        		new Company(rs.getLong(COMPANY_ID), rs.getString(COMPANY_NAME)));	        
	        } catch (Exception e) {
